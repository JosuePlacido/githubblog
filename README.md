...
It's a application to simulate a blog.

The layout on [FIGMA](https://www.figma.com/community/file/1138814951106121051).
...
[Challenge 3: Github Blog](https://efficient-sloth-d85.notion.site/Desafio-03-Github-Blog-13593953670346908462ddc648d42cf1)

1. list the profile info, like image, followers, name etc:.;
1. list and filter the posts(issues);
1. create post details page;
1. apply performance hooks
